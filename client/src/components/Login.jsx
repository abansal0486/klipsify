      ...
      <div className="w-full md:h-full  flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-5">
          <div className="bg-white w-full max-w-[480px] p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 flex flex-col">
            <h1 className="text-2xl md:text-[32px] font-playfair font-bold  mb-6">
              Welcome back
            </h1>
            ...
            >
              ...
              <div className="flex items-center justify-between mt-1 px-1">
                <div className="flex items-center gap-2">
                  ...
                  <label
                    htmlFor="remember"
                    className="text-[10px] cursor-pointer text-gray-600 font-poppins"
                  >
                    Remember me
                  </label>
                </div>
                <Link
                  ...
                  className="text-[10px] cursor-pointer text-blue-600 hover:underline font-poppins"
                >
                  Forgot password?
                </Link>
              </div>
